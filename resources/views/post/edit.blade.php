            ...
            <div class="col s12 m6 l6 offset-m3 offset-l3">
                <div class="card darken-1">
                    <div class="card-content">
                        <span class="card-title center">Edit Post</span>

                        <div class="row">
                            <form class="form-horizontal" method="POST" action="{{route('epost2',[$id,$id2])}}"
                                ...
                                <div class="form-group{{ $errors->has('text') ? ' invalid' : '' }} col s12">
                                    ...
                                    <div class="">
                            <textarea id="text" type="text" class="form-control materialize-textarea" name="text" required data-length="1000" >{{$clubpost[0]->text}}
                            </textarea>
